...
def collate_fn(recs):
    ...
    def to_tensor_dict(recs):
        ...
        seq_lens = torch.FloatTensor(map(lambda r: r['seq_len'], recs))
        ...
        return {'values': values, 'forwards': forwards, 'masks': masks, 'deltas': deltas, 'evals': evals, 'eval_masks': eval_masks, 'seq_len': seq_lens}
